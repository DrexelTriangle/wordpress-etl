...
class AuthorFormatter(Formatter):
    ...
    def format(self, table="authors"):
        createTbl = f"CREATE TABLE {table} (id INT AUTO_INCREMENT PRIMARY KEY, display_name VARCHAR(255), first_name VARCHAR(255), last_name VARCHAR(255), email VARCHAR(255), login VARCHAR(255));"
